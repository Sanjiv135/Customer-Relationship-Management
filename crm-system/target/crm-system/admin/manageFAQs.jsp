...
<head>
    ...
    <title>Manage FAQs - CRM System</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-question-circle"></i> Manage FAQs</h1>
                    
                    <a href="${pageContext.request.contextPath}/admin?action=addFAQ" class="btn btn-primary">
                                ...
                                <tbody>
                                    <% if (faqs != null && !faqs.isEmpty()) { %>
                                        <% for (FAQ faq : faqs) { 
                                            ...
                                            String shortAnswer = answer.length() > 50 ? answer.substring(0, 50) + "..." : answer;
                                            String category = faq.getCategory() != null ? faq.getCategory() : "General";
                                            String createdBy = faq.getCreatedByName() != null ? faq.getCreatedByName() : "System";
                                            String createdAt = faq.getCreatedAt() != null ? faq.getCreatedAt().toString() : "";
                                        %>
                                            <tr data-faq-id="<%= faq.getId() %>">
                                                <td><%= faq.getId() %></td>
                                                <td><%= question %></td>
                                                <td><%= shortAnswer %></td>
                                                <td><%= category %></td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/admin?action=editFAQ&id=<%= faq.getId() %>" 
                                                           class="btn btn-sm btn-warning">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        
                                                        <a href="${pageContext.request.contextPath}/admin?action=deleteFAQ&id=<%= faq.getId() %>" 
                                                           class="btn btn-sm btn-danger"
                                                           onclick="return confirm('Are you sure you want to delete this FAQ: <%= question.replace("\"", "&quot;") %>?')">
                                    ...
                                    <% } else { %>
                                        <tr>
                                            <td colspan="7" class="text-center text-muted py-4">
                                                ...
                                                No FAQs found. <a href="${pageContext.request.contextPath}/admin?action=addFAQ">Create the first FAQ</a>
                                            </td>
                                        </tr>
                                    <% } %>
                                </tbody>
